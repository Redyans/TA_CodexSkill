...
| Specular AA 与法线贴图方差过滤参考 | [ShaderDevelopment/references/specular-aa-and-normal-map-filtering.md](ShaderDevelopment/references/specular-aa-and-normal-map-filtering.md) | 几何/纹理法线方差、smoothness/roughness 转换、BRDF 接入、强制开启取舍、常见错误与验证回退。 |
| 当前工程 BaseLit Specular AA Profile | [ShaderDevelopment/Profiles/ProjectACG/base-lit-specular-aa.md](ShaderDevelopment/Profiles/ProjectACG/base-lit-specular-aa.md) | ProjectACG `PackedMaskPBR` 的实际落点、投影模式、`_BumpMap` 数据流、无开关决策、几何法线覆盖和未验证边界。 |
| 溶解空间、阈值与材质生命周期参考 | [ShaderDevelopment/references/dissolve-space-threshold-and-material-lifecycle.md](ShaderDevelopment/references/dissolve-space-threshold-and-material-lifecycle.md) | UV/本地/世界/屏幕采样、0-1 阈值、定向范围、骨骼传值、材质实例与 Undo 预览生命周期。 |
| 当前工程角色死亡溶解 Profile | [ShaderDevelopment/Profiles/ProjectACG/character-death-dissolve.md](ShaderDevelopment/Profiles/ProjectACG/character-death-dissolve.md) | ProjectACG `CharacterDeath + Chara_V2` 的参数、轴向空间、材质/MPB 写入、撤回丢材质根因、提交证据和验证边界。 |
| 加密 Shader 解密恢复与 ShaderGUI 迁移参考 | [ShaderDevelopment/references/shader-decryption-recovery-and-shadergui-migration.md](ShaderDevelopment/references/shader-decryption-recovery-and-shadergui-migration.md) | 解密后的 `CustomEditor` 反编译、精确 Shader 名分支陷阱、Property/Mode/Keyword/顶点流映射、兼容 GUI、Blend/Queue 联动和跨工程迁移文件闭包。 |
...
| Shader 变体裁剪与构建安全 | [ShaderDevelopment/references/shader-variant-stripping-and-build-safety.md](ShaderDevelopment/references/shader-variant-stripping-and-build-safety.md) | `IPreprocessShaders` 回调粒度、Editor Pass/关键字/局部组合/全量剔除分层、证据采集、零变体风险和回退。 |
| 当前工程 Shader 变体裁剪 Profile | [ShaderDevelopment/Profiles/ProjectACG/shader-variant-stripping.md](ShaderDevelopment/Profiles/ProjectACG/shader-variant-stripping.md) | ProjectACG 的 TEngine 裁剪器、SVC 白名单、6 个全量剔除项、Lit 引用风险和验证边界。 |
| URP Shader 资源所有权与 Bundle 去重 | [ShaderDevelopment/references/urp-shader-resource-ownership-and-bundle-dedup.md](ShaderDevelopment/references/urp-shader-resource-ownership-and-bundle-dedup.md) | 区分源文件、运行时 Shader 对象和变体；沿 URP Pipeline/Renderer/PostProcessData 与 AssetBundle 收集链定位 `UberPost` 等重复资源，建立唯一所有者和验证矩阵。 |
| 当前工程 URP 资源所有权与 Bundle 去重 Profile | [ShaderDevelopment/Profiles/ProjectACG/urp-resource-ownership-and-bundle-dedup.md](ShaderDevelopment/Profiles/ProjectACG/urp-resource-ownership-and-bundle-dedup.md) | ProjectACG 的 URP 资产排除、质量映射、YooAsset 收集器、运行时加载边界、已改文件和当前静态/待补验证证据。 |
| URP 材质默认值、3ds Max 导入与 SH 求值参考 | [ShaderDevelopment/references/urp-material-import-and-sh-evaluation.md](ShaderDevelopment/references/urp-material-import-and-sh-evaluation.md) | 默认材质 Shader、Physical Material→Unlit 数据适配、`Per Pixel` SH、Mixed Lighting 变体区分和构建/视觉验证。 |
| 当前工程 URP 材质导入与 SH 求值 Profile | [ShaderDevelopment/Profiles/ProjectACG/urp-material-import-and-sh-evaluation.md](ShaderDevelopment/Profiles/ProjectACG/urp-material-import-and-sh-evaluation.md) | ProjectACG 的导入器版本、Unlit 映射、默认材质策略、8 个质量档 URP Asset、Lit 引用风险和未验证边界。 |
| Bloom Toon 算法对齐与 Blur 排查 | [ShaderDevelopment/references/bloom-toon-parity-and-debugging.md](ShaderDevelopment/references/bloom-toon-parity-and-debugging.md) | Bloom 亮部提取、Gaussian 核、横/纵向 CommandBuffer 状态、Mip/Atlas 对齐、Frame Debugger 和 A/B 验证。 |
| 当前工程 Bloom Toon URP14 移植 Profile | [ShaderDevelopment/Profiles/ProjectACG/bloom-toon-urp14-port.md](ShaderDevelopment/Profiles/ProjectACG/bloom-toon-urp14-port.md) | ProjectACG URP14 `Bloom` 合并入口、6/9/16/20 点核、13 Draw、已解决的纵向覆盖问题和未闭环边界。 |
| 场景 RenderSettings 总控与实时彩色阴影参考 | [ShaderDevelopment/references/scene-render-settings-and-colored-shadow.md](ShaderDevelopment/references/scene-render-settings-and-colored-shadow.md) | 实时阴影染色、GI/Lightmap 边界、公共 HLSL、全局参数所有权、Slider 兼容迁移、MixMap 固定读取和总控设计。 |
| 当前工程 BaseLit 彩色阴影与 RenderSettings Profile | [ShaderDevelopment/Profiles/ProjectACG/scene-baselit-colored-shadow-and-render-settings.md](ShaderDevelopment/Profiles/ProjectACG/scene-baselit-colored-shadow-and-render-settings.md) | ProjectACG `BaseLit` 路径、217 个材质、MixMap/Slider 扫描、控制器 GUID、POS 合并、真实全局写入者、验证边界与总控未实现项。 |
...
| Unity 模型导入规则与编译快照参考 | [ToolDevelopment/references/unity-model-import-rules-and-snapshot.md](ToolDevelopment/references/unity-model-import-rules-and-snapshot.md) | 预设源、ProjectSettings 编译快照、目录/文件名优先级、限定 `OnPreprocessModel`、显式重导入、问题排查与验证矩阵。 |
| 当前工程通用模型导入规则 Profile | [ToolDevelopment/Profiles/ProjectACG/model-import-rule-pipeline.md](ToolDevelopment/Profiles/ProjectACG/model-import-rule-pipeline.md) | ProjectACG 的 Model/Rig/Animation/Materials 规则、菜单、资产路径、独立实现、验证证据与当前限制。 |
...
| 3ds Max Spring 动画编辑与可逆 Bake | [DCCDevelopment/references/3ds-max-spring-controller-edit-and-reversible-bake.md](DCCDevelopment/references/3ds-max-spring-controller-edit-and-reversible-bake.md) | Quick Edit、真正 Bypass、显式 `Time`、顺序采样、PRS Controller/Key 语义、动态 Scale、直接/List 可逆存储、预检回滚与验证矩阵。 |
| 当前工程 Spring Animation Baker | [DCCDevelopment/Profiles/ProjectACG/spring-animation-baker.md](DCCDevelopment/Profiles/ProjectACG/spring-animation-baker.md) | ProjectACG `2.1.0` 路径、胸部 Rig、直接 PRS、兼容/严格 Bake、逐版诊断证据、时间单位根因和当前待验边界。 |
...
| Timeline 资产生成、Prefab 绑定与增量组装 | [TimelineDevelopment/references/timeline-asset-generation-and-prefab-binding.md](TimelineDevelopment/references/timeline-asset-generation-and-prefab-binding.md) | 模块生成/组装分离、原路径更新、工具轨道所有权、Prefab 持久对象二次绑定、单轨 Transform/FOV、分作用域自检与回退。 |
| Timeline 嵌套 Prefab 保存与生成器绑定 | [TimelineDevelopment/references/timeline-nested-prefab-save-and-generated-binding.md](TimelineDevelopment/references/timeline-nested-prefab-save-and-generated-binding.md) | 最近实例根解析、外层 Prefab 拒绝策略、克隆解包后写回、同步导入与实例覆盖清理、重复源阻止、生成器字段写入与运行时验证。 |
| Timeline 镜头制作、Editor 预览与运行边界 | [TimelineDevelopment/references/timeline-camera-authoring-editor-preview-and-runtime-boundary.md](TimelineDevelopment/references/timeline-camera-authoring-editor-preview-and-runtime-boundary.md) | DCC 相机单轨多 Clip、Transform/FOV 同动画、Virtual/Direct/Entity 三模式、临时 Brain、相机状态恢复、Player 空操作与正式运行接入边界。 |
| BlendShape Timeline 制作与动态绑定 | [TimelineDevelopment/references/timeline-blendshape-track-authoring-and-runtime-binding.md](TimelineDevelopment/references/timeline-blendshape-track-authoring-and-runtime-binding.md) | 多 Renderer/BlendShape 编辑、搜索下拉、双绑定模式、动态模型 Generic Binding、Mixer/Layer 混合、原值恢复、缓存性能、故障矩阵与验证回退。 |
| 当前工程 BlendShape Control Track Profile | [TimelineDevelopment/Profiles/ProjectACG/blendshape-control-track.md](TimelineDevelopment/Profiles/ProjectACG/blendshape-control-track.md) | ProjectACG 当前轨道文件、绑定 API、混合模式、实现能力、静态编译证据与尚未完成的 Unity 行为验证。 |
| 当前工程挂点跟随轨道 Profile | [TimelineDevelopment/Profiles/ProjectACG/mount-follow-track.md](TimelineDevelopment/Profiles/ProjectACG/mount-follow-track.md) | ProjectACG `fx` 命名空间的两条挂点跟随轨道、片段类型隔离、绑定对象自身与子层级皆可作挂点、解析范围、片段面板校验、刷新与恢复策略、性能现状与验证边界。 |
| 当前工程 Timeline 基础资产生成器 | [ToolDevelopment/Profiles/ProjectACG/ultimate-skill-timeline-generator.md](ToolDevelopment/Profiles/ProjectACG/ultimate-skill-timeline-generator.md) | ProjectACG 大招/剧情/抽卡三种制作类型、三种镜头模式、Editor-only 预览边界、单轨多镜头/FOV、模块生成/组装、Prop/FX/Shot 持久绑定和验证状态。 |
| Unity ModelImporter 预设与安全 Mesh/Prefab 生成参考 | [ToolDevelopment/references/model-importer-preset-and-safe-mesh-generation.md](ToolDevelopment/references/model-importer-preset-and-safe-mesh-generation.md) | 临时导入设置、独立覆盖、外置 Mesh、原值快照/恢复、异常回滚和双工程同步检查。 |
| 当前工程 CharacterPrefabBuilder ModelImporter 预设 Profile | [ToolDevelopment/Profiles/ProjectACG/character-prefab-model-importer-preset.md](ToolDevelopment/Profiles/ProjectACG/character-prefab-model-importer-preset.md) | ProjectACG 两个 Client checkout 的配置字段、实现路径、同步边界、验证证据和未验证项。 |
...
| Windows 多工程窗口与分支识别参考 | [ToolDevelopment/references/development-environment-window-and-branch-context.md](ToolDevelopment/references/development-environment-window-and-branch-context.md) | TidyTabs 窗口聚合、VS Code 工程路径标题、Git/GitLens 分支显示层、扩展验证、问题排查与回退边界。 |
