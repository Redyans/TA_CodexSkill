...
| Timeline 资产生成、Prefab 绑定与增量组装 | [TimelineDevelopment/references/timeline-asset-generation-and-prefab-binding.md](TimelineDevelopment/references/timeline-asset-generation-and-prefab-binding.md) | 模块生成/组装分离、原路径更新、Track 与 Clip 子资产保存、Prefab 持久对象二次绑定、Cinemachine/FOV 曲线迁移、分作用域自检与回退。 |
...
| 当前工程大招 Timeline 基础资产生成器 | [ToolDevelopment/Profiles/ProjectACG/ultimate-skill-timeline-generator.md](ToolDevelopment/Profiles/ProjectACG/ultimate-skill-timeline-generator.md) | ProjectACG 大招工具的 Odin UI、多个动作/镜头、固定命名与层级、单模块生成/组装、Cinemachine/FOV、Prop/FX/Shot 持久绑定、已解决问题和验证边界。 |
